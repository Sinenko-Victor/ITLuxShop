<div id="pages_list">
    ...
    <tr>
        ...
        <th width="100">
            Все:
            <a href="/admin/goodsfoto/movefotos" title='Добавить все фото' onClick="return window.confirm('При нажатии &quot;ОК&quot; Все фото для которых есть товары в базе будут добавлены! Добавить?');">
